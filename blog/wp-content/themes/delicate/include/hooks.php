...
function yh_custom_background() {
        ...
        if ($color) {
?>
            <script>window.onload=function() { document.body.style.backgroundColor='#<?php echo $color ?>'; };</script>
<?php
        }
...
add_custom_background('yh_custom_background'); // Add support for custom backgrounds
